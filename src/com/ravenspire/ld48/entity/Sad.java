...
public class Sad 
{
	...
	Game game;
	public ImageIcon img1 = new ImageIcon(this.getClass().getResource("/resources/People/baby.png"));
	public ImageIcon sad = new ImageIcon(this.getClass().getResource("/resources/People/sad.png"));		
